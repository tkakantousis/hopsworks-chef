...
cookbook 'hops', github: "tkakantousis/hops-hadoop-chef", branch: "HOPSWORKS-838"
cookbook 'ndb', github: "logicalclocks/ndb-chef", branch: "master"
cookbook 'hadoop_spark', github: "tkakantousis/spark-chef", branch: "HOPSWORKS-838"
...
cookbook 'livy', github: "logicalclocks/livy-chef", branch: "HOPSWORKS-838"
