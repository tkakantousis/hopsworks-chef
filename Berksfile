...
cookbook 'conda', github: "tkakantousis/conda-chef", branch: "download_url"
cookbook 'kagent', github: "tkakantousis/kagent-chef", branch: "download_url"
...
cookbook 'hopslog', github: "tkakantousis/hopslog-chef", branch: "HOPSWORKS-1005"
